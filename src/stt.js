...
export const stt_system = {
	...
	// a more or less self contained speech to text component
	...
	stt: {
		...
		// this is a test - this method handle can be overridden by a direct wire if desired
		// @todo relying on global sys is not ideal can this be improved?
		human_out: (blob)=> { sys(blob) }
	},
	...
	// watch public event streams to enable or disable this module - @todo could use a simple filter
